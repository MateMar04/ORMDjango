...
class Clientes(models.Model):
    ...
    apellido = models.CharField(db_column='APELLIDO', max_length=30, blank=True,
                                null=True)  # Field name made lowercase.
    nombre = models.CharField(db_column='NOMBRE', max_length=30, blank=True, null=True)  # Field name made lowercase.
    cod_calle = models.ForeignKey(Calles, models.DO_NOTHING, db_column='COD_CALLE', blank=True,
                                  null=True)  # Field name made lowercase.
    altura = models.IntegerField(db_column='ALTURA', blank=True, null=True)  # Field name made lowercase.
    cod_barrio = models.ForeignKey(Barrios, models.DO_NOTHING, db_column='COD_BARRIO', blank=True,
                                   null=True)  # Field name made lowercase.
    cod_localidad = models.ForeignKey('Localidades', models.DO_NOTHING, db_column='COD_LOCALIDAD', blank=True,
                                      null=True)  # Field name made lowercase.
    cod_provincia = models.ForeignKey('Provincias', models.DO_NOTHING, db_column='COD_PROVINCIA', blank=True,
                                      null=True)  # Field name made lowercase.
    telefono = models.DecimalField(db_column='TELEFONO', max_digits=10, decimal_places=0, blank=True,
                                   null=True)  # Field name made lowercase.
    cod_condicion_iva = models.ForeignKey('CondicionesIva', models.DO_NOTHING, db_column='COD_CONDICION_IVA',
                                          blank=True, null=True)  # Field name made lowercase.
    cuit = models.DecimalField(db_column='CUIT', max_digits=10, decimal_places=0, blank=True,
                               null=True)  # Field name made lowercase.
...
class CondicionesIva(models.Model):
    cod_condicion_iva = models.IntegerField(db_column='COD_CONDICION_IVA',
                                            primary_key=True)  # Field name made lowercase.
    descripcion = models.CharField(db_column='DESCRIPCION', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
...
class DetallesFacturas(models.Model):
    ...
    cod_planta = models.ForeignKey('Plantas', models.DO_NOTHING, db_column='COD_PLANTA', blank=True,
                                   null=True)  # Field name made lowercase.
    cantidad = models.IntegerField(db_column='CANTIDAD', blank=True, null=True)  # Field name made lowercase.
    nro_factura = models.ForeignKey('Facturas', models.DO_NOTHING, db_column='NRO_FACTURA', blank=True,
                                    null=True)  # Field name made lowercase.
...
class Facturas(models.Model):
    ...
    cod_forma_pago = models.ForeignKey('FormasPago', models.DO_NOTHING, db_column='COD_FORMA_PAGO', blank=True,
                                       null=True)  # Field name made lowercase.
    cod_cliente = models.ForeignKey(Clientes, models.DO_NOTHING, db_column='COD_CLIENTE', blank=True,
                                    null=True)  # Field name made lowercase.
...
class Plantas(models.Model):
    ...
    descripcion = models.CharField(db_column='DESCRIPCION', max_length=20, blank=True,
                                   null=True)  # Field name made lowercase.
    cod_tipo_planta = models.ForeignKey('TiposPlantas', models.DO_NOTHING, db_column='COD_TIPO_PLANTA', blank=True,
                                        null=True)  # Field name made lowercase.
    precio = models.DecimalField(db_column='PRECIO', max_digits=8, decimal_places=2, blank=True,
                                 null=True)  # Field name made lowercase.
